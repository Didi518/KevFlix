...
import { addFavorite, removeFavorite } from '../app/features/userSlice';
...
const MediaDetail = () => {
  ...
  const onFavoriteClick = async () => {
    ...
    if (response) {
      ...
      setIsFavorite(true);
      toast.success('Ajouté à votre liste de favoris');
    }
  };
  ...
  const onRemoveFavorite = async () => {
    ...
    if (response) {
      ...
      setIsFavorite(false);
      toast.success('Retiré de votre liste de favoris');
    }
  };
    ...
    <>
      ...
      >
        ...
        <MediaReview
          ...
          mediaType={mediaType}
        />
        <Container header="Vous aimerez aussi">
